...
{
  new (message_memory) first_package_msgs::srv::Capture_Request(_init);
}

void Capture_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<first_package_msgs::srv::Capture_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Capture_Request_message_member_array[1] = {
  {
    ...
    offsetof(first_package_msgs::srv::Capture_Request, structure_needs_at_least_one_member),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Capture_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(first_package_msgs::srv::Capture_Request),
...
get_message_type_support_handle<first_package_msgs::srv::Capture_Request>()
{
  return &::first_package_msgs::srv::rosidl_typesupport_introspection_cpp::Capture_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_package_msgs, srv, Capture_Request)() {
  return &::first_package_msgs::srv::rosidl_typesupport_introspection_cpp::Capture_Request_message_type_support_handle;
}
...
void Capture_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) first_package_msgs::srv::Capture_Response(_init);
}

void Capture_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<first_package_msgs::srv::Capture_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Capture_Response_message_member_array[1] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(first_package_msgs::srv::Capture_Response, save_path),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Capture_Response_message_members = {
  ...
  1,  // number of fields
  sizeof(first_package_msgs::srv::Capture_Response),
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<first_package_msgs::srv::Capture_Response>()
{
  return &::first_package_msgs::srv::rosidl_typesupport_introspection_cpp::Capture_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_package_msgs, srv, Capture_Response)() {
  return &::first_package_msgs::srv::rosidl_typesupport_introspection_cpp::Capture_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Capture_service_members = {
  ...
  // see get_service_type_support_handle<first_package_msgs::srv::Capture>()
...
get_service_type_support_handle<first_package_msgs::srv::Capture>()
{
  // get a handle to the value to be returned
  auto service_type_support =
    &::first_package_msgs::srv::rosidl_typesupport_introspection_cpp::Capture_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, first_package_msgs, srv, Capture)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<first_package_msgs::srv::Capture>();
}
