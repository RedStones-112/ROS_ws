...
#ifndef FIRST_PACKAGE_MSGS__SRV__DETAIL__MULTI_SPAWN__FUNCTIONS_H_
#define FIRST_PACKAGE_MSGS__SRV__DETAIL__MULTI_SPAWN__FUNCTIONS_H_
 ...
 * calls
 * first_package_msgs__srv__MultiSpawn_Request__init().
...
/**
 * It calls
 * first_package_msgs__srv__MultiSpawn_Request__fini()
 ...
 * first_package_msgs__srv__MultiSpawn_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * first_package_msgs__srv__MultiSpawn_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * first_package_msgs__srv__MultiSpawn_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_package_msgs
...
/**
 * It calls
 * first_package_msgs__srv__MultiSpawn_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_first_package_msgs
...
/**
 * It allocates the memory for the array and calls
 * first_package_msgs__srv__MultiSpawn_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_first_package_msgs
...
/**
 * It calls
 * first_package_msgs__srv__MultiSpawn_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // FIRST_PACKAGE_MSGS__SRV__DETAIL__MULTI_SPAWN__FUNCTIONS_H_
