...
#include <stddef.h>
#include "first_package_msgs/action/detail/dist_turtle__rosidl_typesupport_introspection_c.h"
...
static rosidl_typesupport_introspection_c__ServiceMembers first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_members = {
  "first_package_msgs__action",  // service namespace
  "DistTurtle_SendGoal",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_Request_message_type_support_handle,
  NULL  // response message
  // first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_Response_message_type_support_handle
};

static rosidl_service_type_support_t first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_type_support_handle = {
  0,
  &first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_package_msgs, action, DistTurtle_SendGoal)() {
  if (!first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_type_support_handle.typesupport_identifier) {
    first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_type_support_handle.data;
  ...
  return &first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_SendGoal_service_type_support_handle;
}
...
// this is intentionally not const to allow initialization later to prevent an initialization race
static rosidl_typesupport_introspection_c__ServiceMembers first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_members = {
  "first_package_msgs__action",  // service namespace
  "DistTurtle_GetResult",  // service name
  // these two fields are initialized below on the first access
  NULL,  // request message
  // first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_Request_message_type_support_handle,
  NULL  // response message
  // first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_Response_message_type_support_handle
};

static rosidl_service_type_support_t first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_type_support_handle = {
  0,
  &first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_members,
  get_service_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, first_package_msgs, action, DistTurtle_GetResult)() {
  if (!first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_type_support_handle.typesupport_identifier) {
    first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  rosidl_typesupport_introspection_c__ServiceMembers * service_members =
    (rosidl_typesupport_introspection_c__ServiceMembers *)first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_type_support_handle.data;
  ...
  return &first_package_msgs__action__detail__dist_turtle__rosidl_typesupport_introspection_c__DistTurtle_GetResult_service_type_support_handle;
}
